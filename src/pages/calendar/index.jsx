  ...
  return (
    <div className="p-4 flex bg-(--background) h-full flex-col gap-6">
      ...
      <div className="w-full bg-(--background) p-4">
        <iframe
          src="https://sslecal2.investing.com?ecoDayBackground=%23ffffff&innerBorderColor=%235700d9&borderColor=%238500c7&columns=exc_flags,exc_currency,exc_importance,exc_actual,exc_forecast,exc_previous&features=datepicker,timezone,timeselector&countries=6,37,72,22,17,35,4,5&calType=week&timeZone=8&lang=1"
          width="100%"
          height="467"
          loading="lazy"
          frameborder="0"
